...
class Task {
    constructor(title, description, userId, options = {}) {
        ...
        this._createdAt = options.createdAt ? new Date(options.createdAt) : new Date(Date.now());
        ...
        this._updatedAt = options.updatedAt ? new Date(options.updatedAt) : new Date(Date.now());
    ...
    get isOverdue() {
        ...
        return new Date(Date.now()) > this._dueDate;
    }
    ...
    clone() {
        ...
        clonedData.createdAt = new Date(Date.now());
        clonedData.updatedAt = new Date(Date.now());

...
console.log('📁 Loading user-repository.js...');

/**
 * User Repository
 * Handles all data access operations for User entities
 * 
 * NOTE: BaseRepository is defined and exported by task-repository.js
 * This file assumes BaseRepository is already available in the global scope
 */
class UserRepository extends (typeof BaseRepository !== 'undefined' ? BaseRepository : class {
    async create(entity) { throw new Error('BaseRepository not initialized'); }
    async findById(id) { throw new Error('BaseRepository not initialized'); }
    async findAll(options = {}) { throw new Error('BaseRepository not initialized'); }
    async update(id, updates) { throw new Error('BaseRepository not initialized'); }
    async delete(id) { throw new Error('BaseRepository not initialized'); }
}) {
...
(function() {
    if (typeof module !== 'undefined' && module.exports) {
        ...
        // Ensure we wait for BaseRepository to be defined
        window.UserRepository = UserRepository;
        console.log('✅ UserRepository exported to window');
    }
})();
